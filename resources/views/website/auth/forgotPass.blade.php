...
<body>
    <div class="containerAll">
        ...
        <div class="SignUp_right">
            <form action="{{ route('auth.forgetpas.prepare') }}" method="post">
    ...
    <script defer src="/website/Js/logIn&signup/validation_forgotpass_<?= session('lang') ?>.js" type="module"></script>
