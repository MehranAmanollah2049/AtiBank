...
<div class="col-md-12">
    <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" id="Form_insert" method="post" action="/admin/answers/add">
            @csrf
            <div class="box-body">
                <div class="form-group">
                    <label for="exampleInputEmail1">متن پاسخ گویی</label>
                    <textarea type="text" name="answer_text" class="form-control" id="exampleInputEmail1" placeholder="متن پاسخویی ..."></textarea>
                </div>
                <input type="hidden" name="comment_id" value="{{ $comment_id }}">
                <input type="hidden" name="user_id_receiver" value="{{ $user_id_receiver }}">
                <input type="hidden" name="Receiver" value="{{ $getterType }}">
            </div>
            <!-- /.box-body -->
